...
const ADMIN: Capabilities = {
    ...
    canEditGrades: true, canReopenEvaluations: true, canEditStudents: true, canCoordinate: true,
};
const EVALUADOR: Capabilities = {
    canManageUsers: false, canViewReports: false, canImportStudents: false,
    canEditGrades: false, canReopenEvaluations: false, canEditStudents: false, canCoordinate: false,
};
